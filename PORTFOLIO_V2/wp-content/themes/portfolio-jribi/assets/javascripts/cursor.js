...
$(function  () {
  ...
  $(document).on('mouseenter', 'a,input,textarea, .c-hover', function() {
    $('.cursor').addClass('hover');
  });
  $(document).on('mouseleave', 'a,input,textarea, .c-hover', function() {
    $('.cursor').removeClass('hover');
  });
  $(document).on('mousedown', 'a,input,textarea, .c-hover', function() {
    $('.cursor').removeClass('hover');
  });
